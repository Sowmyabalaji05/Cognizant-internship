        ...
        <Row>
          <Col lg="4" md="4" sm="12">
            ...
            compare, and book rental vehicles for their desired location and travel dates.
             ...
             these websites provide a seamless and efficient way for individuals to access reliable transportation during their trips, 
             ensuring a hassle-free and flexible travel experience.
            </p>
          </Col>
          ...
          <Col lg="3" md="4" sm="6">
            <div className="mb-4">
              ...
              <p className="office__info">123 Anna nagar, chennai, Tamil nadu,India</p>
              <p className="office__info">Phone: +9194645889365</p>
          ...
          <Col lg="12">
            <div className="footer__bottom">
              <p className="section__description d-flex align-items-center justify-content-center gap-1 pt-4">
                ...
                Sowmya Balaji. All rights reserved.
              </p>
            </div>
          </Col>
        </Row>
